...
const BIRTH_TASKS = [
  ...
  { id: "pre_maternity_book",  phase: "pre",    label: "母子手帳の受け取り", url: "https://www.city.yokohama.lg.jp/kosodate-kyoiku/oyakokenko/shido/kenshin/boshitetyou.html", showFrom: null },
  ...
  // 出生後すぐ（〜14日）
  { id: "post_birth_reg",       phase: "post0",  label: "出生届の提出", deadline: 14, url: "https://www.city.yokohama.lg.jp/kurashi/koseki-zei-hoken/todokede/koseki-juminhyo/todokede-touroku/koseki/syuxtusyou.html" },
...
function renderShoppingItems(catId, items) {
  ...
  sorted.forEach(([itemId, item]) => {
    ...
    li.innerHTML = `
      ...
      <button class="shopping-edit-btn" type="button" title="編集">✏️</button>
